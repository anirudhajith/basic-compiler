...
program: decl_list														{ int h[1] = {$1.h}; int d[1] = {$1.d};			$$.h = getH(1, h); $$.d = getD(1, h, d); 	programDiameter = $$.d; }
;
...
struct_decl: STRUCT identifier '{' local_decls '}' ';'					{ int h[6] = {$1.h, $2.h, 0, $4.h, 0, 0}; int d[6] = {$1.d, $2.d, 0, $4.d, 0, 0};			$$.h = getH(6, h); $$.d = getD(6, h, d); }
;
...
var_decl: type_spec identifier ';'										{ int h[3] = {$1.h, $2.h, 0}; int d[3] = {$1.d, $2.d, 0};			$$.h = getH(3, h); $$.d = getD(3, h, d); }
	...
	| type_spec identifier '[' integerLit ']' ',' var_decl				{ int h[7] = {$1.h, $2.h, 0, $4.h, 0, 0, $7.h}; int d[7] = {$1.d, $2.d, 0, $4.d, 0, 0, $7.h};			$$.h = getH(7, h); $$.d = getD(7, h, d); }
;
...
extern_spec: EXTERN 													{ int h[1] = {0}; int d[1] = {0};			$$.h = getH(1, h); $$.d = getD(1, h, d); }
	| epsilon															{ int h[1] = {$1.h}; int d[1] = {$1.d};			$$.h = getH(1, h); $$.d = getD(1, h, d); }
;
...
while_stmt: WHILE '(' expr ')' stmt										{ int h[5] = {0, 0, $3.h, 0, $5.h}; int d[5] = {0, 0, $3.d, 0, $5.d};			$$.h = getH(5, h); $$.d = getD(5, h, d); }
;
...
if_stmt: IF '(' expr ')' stmt											{ int h[5] = {$1.h, 0, $3.h, 0, $5.h}; int d[5] = {$1.d, 0, $3.d, 0, $5.d};			$$.h = getH(5, h); $$.d = getD(5, h, d); }
	| IF '(' expr ')' stmt ELSE stmt									{ int h[7] = {0, 0, $3.h, 0, $5.h, 0, $7.h}; int d[7] = {0, 0, $3.d, 0, $5.d, 0, $7.h};			$$.h = getH(7, h); $$.d = getD(7, h, d); }
;
...
switch_stmt: SWITCH '(' expr ')' '{' compound_case default_case '}'		{ int h[8] = {0, 0, $3.h, 0, 0, $6.h, $7.h, 0}; int d[8] = {0, 0, $3.d, 0, 0, $6.d, $7.h, 0};			$$.h = getH(8, h); $$.d = getD(8, h, d); }
;
...
assign_stmt: identifier '=' expr ';'									{ int h[4] = {$1.h, 0, $3.h, 0}; int d[4] = {$1.d, 0, $3.d, 0};			$$.h = getH(4, h)+1; $$.d = getD(4, h, d); }											
	| identifier '[' expr ']' '=' expr ';'								{ int h[7] = {$1.h, 0, $3.h, 0, 0, $6.h, 0}; int d[7] = {$1.d, 0, $3.d, 0, 0, $6.d, 0};			$$.h = getH(7, h)+1; $$.d = getD(7, h, d); }
	| identifier POINTERMEMBER identifier '=' expr ';'					{ int h[6] = {$1.h, 0, $3.h, 0, $5.h, 0}; int d[6] = {$1.d, 0, $3.d, 0, $5.d, 0};			$$.h = getH(6, h)+1; $$.d = getD(6, h, d); }
	| identifier '.' identifier '=' expr ';'							{ int h[6] = {$1.h, 0, $3.h, 0, $5.h, 0}; int d[6] = {$1.d, 0, $3.d, 0, $5.d, 0};			$$.h = getH(6, h)+1; $$.d = getD(6, h, d); }
;
...
expr: Pexpr '<' Pexpr													{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr '>' Pexpr													{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr LESSEREQ Pexpr												{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr GREATEREQ Pexpr												{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr LOGICALOR Pexpr												{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| SIZEOF '(' Pexpr ')'												{ int h[4] = {0, 0, $3.h, 0}; int d[4] = {0, 0, $3.d, 0};			$$.h = getH(4, h); $$.d = getD(4, h, d); }
	| Pexpr EQEQ Pexpr													{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr NOTEQ Pexpr													{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr THREEWAYCOMP Pexpr											{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr LOGICALAND Pexpr											{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr POINTERMEMBER Pexpr											{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr '+' Pexpr													{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr '-' Pexpr													{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr '*' Pexpr													{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
	| Pexpr '/' Pexpr													{ $$.h = max($1.h, $3.h) + 2; $$.d = max(max($1.d, $3.d), $1.h + $3.h + 1); }
